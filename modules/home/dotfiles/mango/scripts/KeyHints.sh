...
shortcuts=(
  ...
  "[MangoWM] :: SUPER + Arrow Keys :: Move Focus :: mmsg dispatch focusdir [left|right|up|down]"
  "[MangoWM] :: SUPER + SHIFT + Arrow Keys :: Swap Window :: mmsg dispatch exchange_client [left|right|up|down]"
  ...
  "[Noctalia] :: SUPER + P :: Session/Logout Panel :: noctalia msg panel-toggle session"
  "[Noctalia] :: SUPER + I :: Settings Panel :: noctalia msg settings-toggle"
